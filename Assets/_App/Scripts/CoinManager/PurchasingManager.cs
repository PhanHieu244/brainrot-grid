...
public class PurchasingManager : MonoBehaviour
{
	public void OnPressDown(int i)
	{
		...
		{
			case 1:
				IAPManager.OnPurchaseSuccess=() => ScoreHandler.instance.increaseSpecialPoints(5);
            ...
            case 5:
				...
				break;
			case 6:
				IAPManager.OnPurchaseSuccess=() => ScoreHandler.instance.increaseSpecialPoints(200);
